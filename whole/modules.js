/* global objects color THREE sceneThreeJs globalVar splineHelperObjects helperObjects primitive positions:true splinePointsLength:true ARC_SEGMENTS Vector3 angle */
...
function updateSplineOutline () {
  ...
  for (i = 0; i < globalVar.n; i++) {
    var geometry = new THREE.LatheGeometry(points, Math.floor(12 / globalVar.n) + 1, Math.PI / 2 + i * globalVar.dtheta, globalVar.dtheta)
    var mesh0
    var mesh1
    if (i % 2 === 0) {
...
function update3 () {
  ...
  objects.sphere0.add(
    new THREE.Mesh(primitive.Cylinder(Vector3(0, 0, 0), Vector3(0, 0, -globalVar.r * 2), 0.02),
